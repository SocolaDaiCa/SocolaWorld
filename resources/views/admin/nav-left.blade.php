<div class="col-md-3 left_col">
	<div class="left_col scroll-view">
		<div class="navbar nav_title" style="border: 0;">
			<a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Socola Admin</span></a>
		</div>
		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					...
					<li><a href="{{route('admin.users')}}"><i class="fa fa-users"></i> User</a></li>
					<li><a href="{{route('admin.apps')}}" title=""><i class="fa fa-desktop"></i> Apps</a></li>
					<li><a href="{{route('admin.categorys')}}"><i class="fa fa-book"></i> Categorys</a></li>
