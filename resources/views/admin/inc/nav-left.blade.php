		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					...
					<li>
						<a href="{{route('admin.apps.index')}}" title="">
							<i class="fa fa-desktop"></i> Apps</a>
							<ul class="nav child_menu">
								<li><a href="{{route('admin.apps.index')}}" class="hidden" title=""></a></li>
								<li><a href="{{ route('admin.apps.create') }}" title="">Create App</a></li>
							</ul>
					</li>
					<li>
						<a href="setting">
					...
					<li>
						<a>
							<i class="fa fa-home"></i> Config
							<span class="fa fa-chevron-down"></span>
						</a>
						<ul class="nav child_menu">
							<li>
								<a href="set-layout">layout</a>
							</li>
						</ul>
					</li>
					<!-- has test -->
